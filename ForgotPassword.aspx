...
<title>Words Beats & Life Forgot Password</title>
    ...
    <div id="formss">
          ...
          <form id="loginForm" class="form-signin" runat="server">
            ...
            <div>
                ...
                <table>
                    <tr>
                        <td><label id="lblForgotEmail" runat="server"  class="labels" >Email Address: </label></td>
                        <td><asp:TextBox ID="txtForgotEmail" runat="server" ></asp:TextBox></td>
                    </tr>
                ...
                <asp:Button ID="btnForgotEmail" runat="server" text="Send Password Reset Email" Cssclass="btn btn-lg btn-primary btn-block" OnClick="btnForgotEmail_Click" />
            </div>
            </form>
